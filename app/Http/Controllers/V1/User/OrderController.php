...
class OrderController extends Controller
{
    ...
    public function save(OrderSave $request)
    {
        ...
        $domainUser = User::where('staff_url', $currentDomain)->first();

        
        $isDomainUserWithStaffPlan = $domainUser && $domainUser->staff_plan;

        if (!$isDomainUserWithStaffPlan) {
        ...
        $user = User::find($request->user['id']);
            ...
            if (!$isDomainUserWithStaffPlan || $request->input('period') === 'reset_price') {
