...
DROP TABLE IF EXISTS `v2_setsni`;
CREATE TABLE `v2_setsni` (
                            `id` int(11) NOT NULL AUTO_INCREMENT,
                            `dname_sni` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Nền TikTok Viettel',
                            `network_settings` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'm.tiktok.com',
...
CREATE TABLE `v2_user` (
                           ...
                           `invite_user_id` int(11) DEFAULT NULL,
                            ...
                            `email` varchar(64) NOT NULL,
                            `name_user` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
                            `avatar_url` text,
                            ...
                            `device_limit` int(11) DEFAULT NULL,
                            `network_settings` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'm.tiktok.com',
                            `sni_type` int(11) NOT NULL DEFAULT '0',
                            `dname_sni` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Nền TikTok Viettel',
                            `banned` tinyint(1) NOT NULL DEFAULT '0',
                            `is_admin` tinyint(1) NOT NULL DEFAULT '0',
                            `last_login_at` int(11) DEFAULT NULL,
                            `is_staff` tinyint(1) NOT NULL DEFAULT '0',
                            `staff_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                            `staff_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                            `staff_logo` text,
                            `staff_mota` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
                            `staff_zalo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                            `staff_telegram` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                            `staff_plan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
