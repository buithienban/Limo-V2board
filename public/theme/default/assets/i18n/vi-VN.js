window.settings.i18n['vi-VN'] = {
  ...
  '提现金额': 'Số tiền rút',
  '输入提现金额': 'Hãy nhập số tiền rút',
  '确认': 'OK',
  '取消': 'Hủy',
  '提现方式': 'Ngân hàng rút tiền',
  '请选择提现方式': 'Chọn Ngân hàng nhận tiền',
  '提现账号': 'Tài khoản nhận tiền',
  '请输入提现账号': 'Hãy nhập tài khoản nhận tiền',
  '我知道了': 'OK',
  '绑定Telegram': 'Liên kết Telegram',
  '第一步': 'Bước 1',
  '第二步': 'Bước 2',
  ...
  'reset traffic metod 5 {reset_day}': ' Data được reset hàng ngày vào lúc {reset_day}',
  '已用流量已在今日重置': ' data được reset hôm nay',
  '重置已用流量': 'ĐẠT LẠI DUNG LƯỢNG ĐÃ SỬ DỤNG',
