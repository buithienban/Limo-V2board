                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td style="font-size:14px;color:#333;padding:24px 40px 0 40px">
                                ...
                                <br />
                                <br />
                                Dịch vụ của bạn sẽ hết hạn trong vòng 24 giờ. Để không gây ảnh hưởng tới việc sử dụng của bạn, vui lòng gia hạn càng sớm càng tốt. Nếu bạn đã gia hạn, vui lòng bỏ qua email này.
                            </td>
                        </tr>
